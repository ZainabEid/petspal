                ...
                <div class="media">
                    ...
                    <div class="">
                        ...
                        <div class="d-flex flex-row justify-content-between ">
                            ...
                            {{-- author --}}
                            <div>
                                <img src="{{ url($post->author->avatar) ?? 'img/avatars/avatar-5.jpg' }}" width="30"
                                    height="30" class="rounded-circle me-2" alt="{{ $post->author->name }}">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    @foreach ($post->collection() as $index => $image)
                                        <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                            ...
                                            <img class="d-block" width="100px" height="100px"
                                                style="width:100,height:100" src="{{ url($image->getUrl()) }}">
