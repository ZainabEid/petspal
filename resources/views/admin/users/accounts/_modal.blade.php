    ...
    <div id="to-append">
        <div class="modal-card">
            ...
            <footer class="modal-card-foot">
                <button onclick="document.getElementById('update-account-form').submit()" class="button is-success">{{ __('Save changes') }}</button>
