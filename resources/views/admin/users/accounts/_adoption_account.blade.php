    ...
    <div class="col-md-8 col-xl-8">
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                @if (isset($account->gallery) && $account->gallery->count() > 0)

                    @foreach ($account->gallery as $media)

                    <div class="flex-inline ">

                        <iframe src="{{ asset($media->getUrl()) }}" title="W3Schools Free Online Web Tutorials"></iframe>
                    </div>
                ...
                <iframe src="http://lorempixel.com/100/100/cats/1" title="W3Schools Free Online Web Tutorials"></iframe>
